...
int main(void) {
    ...
    scanf("%[^\n]s", palavra);
    informa_freq(palavra, vetor_freq);
    ...
    printf("\n\n%c", raiz->dir->esq->carac);
    printf("\n\n%c", raiz->dir->dir->carac);
    //printf("\n\n%c", raiz->esq->esq->esq->carac);
    //printf("\n\n%c", raiz->esq->esq->dir->carac);
    //printf("\n\n%c", raiz->esq->dir->esq->carac);
    //printf("\n\n%c", raiz->esq->dir->dir->carac);
    free(pilha);
    return 0;
}
