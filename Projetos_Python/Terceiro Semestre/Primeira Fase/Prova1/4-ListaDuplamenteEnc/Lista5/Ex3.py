"""
Implemente uma função que imprima uma lista na ordem reversa, porém pule  sempre um elemento na impressão. 
Isto é, dada a lista:  <- 1 <-> 2 <-> 3 <-> 4 <-> 5 ->  Você deverá imprimir: 5 3 1
"""
