					...
					<div class="form-row">
						...
						<div class="form-group col-12">
							...
							<input
								...
								:class="{
									'is-invalid':
										!isCommonInputsDisabled && !common.age,
								}"
								:required="!isCommonInputsDisabled"
								:disabled="isCommonInputsDisabled"
							/>
							<div
								class="mt-2"
								v-if="!isCommonInputsDisabled && !common.age"
							>
								<small class="invalid">
									Campo obrigatório
								</small>
						...
						<div class="form-group col-12">
							...
							<div
								class="mt-2"
								v-if="
									!isCommonInputsDisabled && !common.density
								"
							>
								<small class="invalid">
									Campo obrigatório
					...
					<div class="form-row">
						...
						<div class="form-group col-12">
							...
							<input
								...
								:class="{
									'is-invalid':
										!isHybridInputsDisabled && !hybrid.age,
								}"
								:required="!isHybridInputsDisabled"
								:disabled="isHybridInputsDisabled"
							/>
							<div
								class="mt-2"
								v-if="!isHybridInputsDisabled && !hybrid.age"
							>
								<small class="invalid">
									Campo obrigatório
								</small>
						...
						<div class="form-group col-12">
							...
							<div
								class="mt-2"
								v-if="
									!isHybridInputsDisabled && !hybrid.density
								"
							>
								<small class="invalid">
									Campo obrigatório
					...
					<div class="form-row">
						...
						<div class="form-group col-12">
							...
							<input
								...
								:class="{
									'is-invalid':
										!isClonedInputsDisabled && !cloned.age,
								}"
								:required="!isClonedInputsDisabled"
								:disabled="isClonedInputsDisabled"
							/>
							<div
								class="mt-2"
								v-if="!isClonedInputsDisabled && !cloned.age"
							>
								<small class="invalid">
									Campo obrigatório
								</small>
						...
						<div class="form-group col-12">
							...
							<div
								class="mt-2"
								v-if="
									!isClonedInputsDisabled && !cloned.density
								"
							>
								<small class="invalid">
									Campo obrigatório
...
export default {
	...
	created() {
		this.common.main = this.block.genotype.common.main;
		this.common.global = this.block.genotype.common.global;
		this.common.temple = this.block.genotype.common.temple;
		this.common.age = this.block.genotype.common.age;
		this.common.density = this.block.genotype.common.density;
		this.common.total_area_participation =
			this.block.genotype.common.total_area_participation;
		this.common.type = this.block.genotype.common.type;

		this.hybrid.main = this.block.genotype.hybrid.main;
		this.hybrid.global = this.block.genotype.hybrid.global;
		this.hybrid.temple = this.block.genotype.hybrid.temple;
		this.hybrid.age = this.block.genotype.hybrid.age;
		this.hybrid.density = this.block.genotype.hybrid.density;
		this.hybrid.total_area_participation =
			this.block.genotype.hybrid.total_area_participation;

		this.cloned.main = this.block.genotype.cloned.main;
		this.cloned.global = this.block.genotype.cloned.global;
		this.cloned.temple = this.block.genotype.cloned.temple;
		this.cloned.age = this.block.genotype.cloned.age;
		this.cloned.density = this.block.genotype.cloned.density;
		this.cloned.total_area_participation =
			this.block.genotype.cloned.total_area_participation;
		this.cloned.type = this.block.genotype.cloned.type;
		this.cloned.type_description =
			this.block.genotype.cloned.type_description;

		this.checkCommonInputs("onCreate");
		this.checkHybridInputs("onCreate");
		this.checkClonedInputs("onCreate");
	},
	...
	methods: {
		checkForm() {
			...
			if (areaParticipation === 0) {
				...
				this.formErrors.areaParticipation.message =
					"Deve haver ao menos um genótipo de cacau na área!";
		...
		checkCommonInputs(type = "") {
			if (
				Number(this.common.total_area_participation) === 0 &&
				type === "onCreate"
			) {
			...
			this.emitEvent("common", this.common);
		},

		checkHybridInputs(type = "") {
			if (
				Number(this.hybrid.total_area_participation) === 0 &&
				type === "onCreate"
			) {
			...
			this.emitEvent("hybrid", this.hybrid);
		},

		checkClonedInputs(type = "") {
			if (
				Number(this.cloned.total_area_participation) === 0 &&
				type === "onCreate"
			) {
				...
				this.cloned.type_description = null;
			} else if (
				Number(this.cloned.total_area_participation) === 0 &&
				type !== "onCreate"
			) {
			...
			this.emitEvent("cloned", this.cloned);
		},

		emitEvent(genotype, data) {
			if (genotype === "common") {
				this.$emit(`${genotype}Type`, data.type);
			}

			if (genotype === "cloned") {
				this.$emit(`${genotype}Type`, data.type);
				this.$emit(`${genotype}TypeDescription`, data.type_description);
			}

			this.$emit(`${genotype}TotalArea`, data.total_area_participation);
			this.$emit(`${genotype}Age`, data.age);
			this.$emit(`${genotype}Density`, data.density);
			this.$emit(`${genotype}Temple`, data.temple);
			this.$emit(`${genotype}Main`, data.main);
			this.$emit(`${genotype}Global`, data.global);
		},
	},
};
</script>
